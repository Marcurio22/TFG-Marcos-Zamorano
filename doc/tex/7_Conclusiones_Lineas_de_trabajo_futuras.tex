...
\begin{itemize}
	...
	\item Relacionado con el sistema de correo, también podría incorporarse un mecanismo de recuperación de contraseña. En caso de que un usuario olvidase sus credenciales, la aplicación podría enviar un enlace temporal de restablecimiento al correo electrónico con el que se registró, utilizando SMTP para gestionar el envío.
