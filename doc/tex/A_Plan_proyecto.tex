...
\begin{equation}
	...
	\frac{\text{Salario bruto anual}}{1.760}
\end{equation}

\begin{equation}
	\text{Coste empresa por hora} =
	\text{Coste bruto por hora} \times (1 + 0{,}3057)
\end{equation}
...
El factor \(0{,}3057\) representa una aproximación a las cotizaciones empresariales a la Seguridad Social, considerando contingencias comunes, desempleo, FOGASA, formación profesional y MEI.
...
\begin{table}[H]
	...
	\begin{tabular}{l r}
		...
		MEI & 0,67\% \\
		\midrule
		\textbf{Total aproximado} & \textbf{30,57\%} \\
		\bottomrule
	\end{tabular}
	\caption{Cotizaciones empresariales consideradas para el cálculo del coste de personal.}
	\label{tab:cotizaciones_empresa}
\end{table}

En el caso del desarrollador principal, se estima una dedicación aproximada de 900 horas. Para la labor de supervisión se considera una dedicación de 30 horas por cada tutor, asociada a reuniones, revisión de avances, orientación técnica y seguimiento del proyecto.

\begin{table}[H]
	\centering
	\small
	\renewcommand{\arraystretch}{1.25}
	\begin{tabular}{p{4.2cm} p{3.2cm} r r r}
		\toprule
		\textbf{Persona} & \textbf{Rol} & \textbf{Horas} & \textbf{Coste empresa/h} & \textbf{Coste} \\
		\midrule
		Marcos Zamorano Lasso & Desarrollador & 900 & 22,26 € & 20.030,63 € \\
		Álvar Arnaiz González & Supervisor & 30 & 33,38 € & 1.001,53 € \\
		David Martínez Acha & Supervisor & 30 & 33,38 € & 1.001,53 € \\
		\midrule
		\textbf{Total} & & \textbf{960} & & \textbf{22.033,69 €} \\
		\bottomrule
	\end{tabular}
...
\begin{equation}
	...
	\frac{\text{Meses del proyecto}}{12}
\end{equation}

Considerando un equipo valorado en 1.200 €, una vida útil de 5 años y una duración del proyecto de 7,5 meses, se obtiene:

\begin{equation}
	\text{Coste hardware} =
	\frac{1.200}{5} \times \frac{7{,}5}{12}
	= 150{,}00\text{ €}
\end{equation}
...
\begin{table}[H]
	...
	\begin{tabular}{l r r r}
		...
		\midrule
		Equipo portátil de desarrollo & 1.200 € & 5 años & 150,00 € \\
		\midrule
...
\begin{table}[H]
	...
	\begin{tabular}{p{4cm} p{7cm} r}
		...
		\midrule
		Python, Flask y extensiones & Desarrollo de la aplicación web y backend & 0,00 € \\
		PyTorch y librerías de inferencia & Ejecución de modelos de segmentación & 0,00 € \\
		SQLite y SQLAlchemy & Persistencia y acceso a datos & 0,00 € \\
		Tailwind CSS, DaisyUI y Leaflet & Interfaz web y visor cartográfico & 0,00 € \\
		Git, GitHub y Zube & Control de versiones y gestión del proyecto & 0,00 € \\
		TeXstudio, MiKTeX y diagrams.net & Documentación y diagramas & 0,00 € \\
		Visual Studio Code y Jupyter Notebook & Desarrollo, pruebas y análisis del algoritmo & 0,00 € \\
		\midrule
...
Por tanto, el coste directo de software se considera nulo. No obstante, esta estimación no implica que el software carezca de valor, sino que las herramientas utilizadas no han requerido pagos adicionales durante el desarrollo del TFG.

\subsubsection{Costes de despliegue y mantenimiento}

Aunque la aplicación puede ejecutarse en local durante el desarrollo y se despliega en una infraestructura universitaria, se estima un escenario de referencia basado en un despliegue básico en un servidor privado virtual. Este escenario permite aproximar el coste que tendría mantener la aplicación disponible durante el periodo equivalente al desarrollo.

Además del alojamiento, debe considerarse una dedicación mensual de mantenimiento para tareas como actualización de dependencias, revisión de logs, copias de seguridad, limpieza de ficheros generados y supervisión del servicio mediante Gunicorn. Se estima una dedicación media de 1,5 horas mensuales durante 7,5 meses.
...
\begin{table}[H]
	...
	\begin{tabular}{p{5cm} r r r}
		...
		\midrule
		Servidor VPS básico & 12,00 €/mes & 7,5 meses & 90,00 € \\
		Dominio web & 12,00 €/año & 7,5 meses & 7,50 € \\
		Almacenamiento y copias de seguridad & 5,00 €/mes & 7,5 meses & 37,50 € \\
		Mantenimiento técnico & 22,26 €/h & 11,25 h & 250,38 € \\
		\midrule
		\textbf{Total} & & & \textbf{385,38 €} \\
		\bottomrule
	\end{tabular}
...
Siguiendo una estimación habitual en este tipo de estudios, se aplica un 15\% sobre el total de costes directos:

\begin{equation}
	\text{Costes indirectos} =
	\text{Costes directos} \times 0{,}15
\end{equation}
...
\begin{table}[H]
	...
	\begin{tabular}{l r}
		...
		\midrule
		Costes de personal & 22.033,69 € \\
		Costes de hardware & 150,00 € \\
		Costes de software & 0,00 € \\
		Costes de despliegue y mantenimiento & 385,38 € \\
		\midrule
		\textbf{Costes directos} & \textbf{22.569,07 €} \\
		Costes indirectos, 15\% & 3.385,36 € \\
		\midrule
		\textbf{Coste total estimado} & \textbf{25.954,43 €} \\
		\bottomrule
	\end{tabular}
