...
A partir de esta revisión, no se aprecian incompatibilidades relevantes para el desarrollo del TFG. No obstante, si el proyecto evolucionase hacia una distribución pública o comercial, sería necesario conservar los textos de licencia de las dependencias y revisar de nuevo aquellas bibliotecas que incorporen modelos, pesos o recursos externos con condiciones particulares.
