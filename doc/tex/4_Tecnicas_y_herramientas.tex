...
Este capítulo tiene como finalidad describir, de manera ordenada y argumentada, las técnicas metodológicas y las herramientas empleadas a lo largo del desarrollo del proyecto. Dado que un Trabajo Fin de Grado no persigue agotar todas las alternativas existentes, el objetivo de este apartado es destacar las decisiones más relevantes que han condicionado la implementación, exponiendo los criterios seguidos para seleccionar tecnologías, bibliotecas y recursos, justificando dichas elecciones en términos de mantenibilidad, productividad, rendimiento, reproducibilidad y viabilidad de uso.

Para ello, se presentan comparativas entre opciones representativas que podrían haber sido utilizadas en el sistema, señalando sus ventajas e inconvenientes en el contexto concreto del proyecto. En particular, se analizan decisiones relacionadas con el \textit{frontend}, la adquisición y explotación de datos geoespaciales y el soporte de persistencia y depuración durante el desarrollo, de modo que el lector disponga de una visión clara del razonamiento técnico que sustenta la solución final.
