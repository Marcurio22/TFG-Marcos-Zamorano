...
\end{itemize}
Se opta finalmente por emplear el \textit{pipeline} basado en \texttt{pickle} como referencia en el sistema, garantizando coherencia con los resultados esperados y una segmentación más fiable en la práctica.
