...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figuras/diagrama_flujo_aplicacion.png}
	\caption{Diagrama de flujo de la arquitectura de la aplicación}
	\label{fig:diagrama_flujo}
\end{figure}

La Figura \ref{fig:diagrama_flujo} representa la arquitectura general de la aplicación y las interacciones entre sus distintos componentes, diferenciando claramente el lado cliente y el lado servidor.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figuras/diagrama_secuencia_aplicacion.png}
	\caption{Diagrama de secuencia de la aplicación}
	\label{fig:diagrama_secuencia}
\end{figure}

La Figura \ref{fig:diagrama_secuencia} describe de forma cronológica el flujo de interacción entre el usuario, el navegador, el servidor Flask y el sistema de almacenamiento, permitiendo comprender el comportamiento dinámico de la aplicación.
